...
namespace ControladorAereoNaval
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            {
                Console.WriteLine("Equipo STEALTH! preparese para despegar con EDI");
            }
            else
            {
                Console.WriteLine("Equipo STEALTH! Abortar Mision, EDI no esta listo para despegar");
            }
